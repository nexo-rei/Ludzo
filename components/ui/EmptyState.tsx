...
function EmptyIllustration({ type }: { type: "default" | "chart" | "task" | "trophy" | "warning" }) {
  if (type === "chart") return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <rect x="8" y="40" width="10" height="16" rx="2" fill="rgba(35,133,108,0.15)" stroke="rgba(35,133,108,0.3)" strokeWidth="1.5" />
      <rect x="22" y="28" width="10" height="28" rx="2" fill="rgba(35,133,108,0.1)" stroke="rgba(35,133,108,0.2)" strokeWidth="1.5" />
      <rect x="36" y="34" width="10" height="22" rx="2" fill="rgba(35,133,108,0.08)" stroke="rgba(35,133,108,0.15)" strokeWidth="1.5" />
      <rect x="50" y="20" width="10" height="36" rx="2" fill="rgba(35,133,108,0.06)" stroke="rgba(35,133,108,0.1)" strokeWidth="1.5" />
      <path d="M6 58h52" stroke="rgba(100,116,139,0.4)" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
  if (type === "task") return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <rect x="12" y="14" width="40" height="8" rx="4" fill="rgba(35,133,108,0.12)" stroke="rgba(35,133,108,0.25)" strokeWidth="1.5" />
      <rect x="12" y="28" width="30" height="8" rx="4" fill="rgba(35,133,108,0.08)" stroke="rgba(35,133,108,0.15)" strokeWidth="1.5" />
      <rect x="12" y="42" width="35" height="8" rx="4" fill="rgba(35,133,108,0.05)" stroke="rgba(35,133,108,0.1)" strokeWidth="1.5" />
  ...
  return (
    <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
      <circle cx="32" cy="28" r="14" fill="rgba(35,133,108,0.1)" stroke="rgba(35,133,108,0.25)" strokeWidth="1.5" />
      <path d="M32 20v8l5 3" stroke="rgba(35,133,108,0.5)" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M16 48c0-8.837 7.163-12 16-12s16 3.163 16 12" stroke="rgba(35,133,108,0.2)" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
}
